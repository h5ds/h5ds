...
export const animatesIn = [
    ...
    { name: '缩小入', type: 'in', animate: 'smallIn', time: '1s', delay: '0s', count: 1, fun: 'ease' },
...
export const animatesOut = [
    ...
    { name: '放大消失', type: 'out', animate: 'toBigFade', time: '1s', delay: '0s', count: 1, fun: 'ease' }
];
...
export const animatesEm = [
    ...
    { name: '呼吸2', type: 'em', animate: 'pulse2', time: '1s', delay: '0s', count: 1, fun: 'ease' },
